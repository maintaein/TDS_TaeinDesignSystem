...
export const Types: Story = {
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', width: '300px' }}>
      ...
      <TextField label="웹사이트" type="url" placeholder="https://example.com" />
    </div>
  ),
}
...
export const ErrorState: Story = {
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', width: '300px' }}>
      <TextField label="이메일" type="email" error errorMessage="올바른 이메일 형식이 아닙니다" />
      <TextField
        label="비밀번호"
        type="password"
        error
...
export const HelperText: Story = {
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', width: '300px' }}>
      <TextField label="사용자명" helperText="4-20자의 영문, 숫자만 사용 가능합니다" />
      <TextField
        label="비밀번호"
        type="password"
...
export const FullWidth: Story = {
  ...
  render: () => (
    <div style={{ width: '100%', maxWidth: '600px' }}>
      <TextField label="전체 너비" fullWidth placeholder="전체 너비를 차지합니다" />
    </div>
  ),
}
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', width: '300px' }}>
      <TextField
        ...
        placeholder="입력해보세요"
      />
      <p style={{ fontSize: '0.875rem', color: '#666' }}>입력된 값: {value || '(없음)'}</p>
    </div>
  )
}
    ...
    <form onSubmit={handleSubmit} style={{ width: '400px' }}>
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        ...
        <TextField
          ...
          required
          error={errors.email}
          errorMessage={errors.email ? '올바른 이메일 형식이 아닙니다' : undefined}
        ...
        <TextField
          ...
          errorMessage={errors.password ? '비밀번호는 최소 8자 이상이어야 합니다' : undefined}
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', width: '400px' }}>
      ...
      <div>
        ...
        <TextField label="이메일" type="email" required placeholder="example@email.com" />
      </div>

      <div>
        <h3 style={{ marginBottom: '1rem' }}>도움말 포함</h3>
        <TextField label="비밀번호" type="password" helperText="8자 이상 입력하세요" />
      </div>
