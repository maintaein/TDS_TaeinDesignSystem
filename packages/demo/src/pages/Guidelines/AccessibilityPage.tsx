  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.description}>
        TDS는 모든 사용자가 동등하게 사용할 수 있도록 설계되었습니다. 시각,
        청각, 운동 능력에 관계없이 누구나 불편 없이 사용할 수 있는 UI를 만드는
        것이 목표입니다.
      </p>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.sectionDescription}>
          웹 접근성은 장애가 있는 사용자도 웹 콘텐츠를 인식하고, 조작하고,
          이해할 수 있도록 보장하는 것입니다. TDS의 모든 컴포넌트는 다음 4가지
          원칙을 따릅니다.
        </p>
        ...
        <div className={styles.principleGrid}>
          <div className={styles.principleCard}>
            ...
            <p className={styles.principleDescription}>
              모든 정보와 UI 요소를 사용자가 감각으로 인식할 수 있어야 합니다.
              이미지에는 대체 텍스트를, 동영상에는 자막을, 텍스트에는 충분한
              색상 대비를 제공합니다.
            </p>
          </div>
          ...
          <div className={styles.principleCard}>
            ...
            <p className={styles.principleDescription}>
              ...
              포커스 표시가 명확하고, 클릭 영역이 충분하며, 시간 제한을 조절할
              수 있어야 합니다.
            </p>
          </div>
          ...
          <div className={styles.principleCard}>
            ...
            <p className={styles.principleDescription}>
              정보와 UI의 동작이 예측 가능해야 합니다. 일관된 네비게이션, 명확한
              레이블, 오류 발생 시 무엇이 잘못되었고 어떻게 고칠 수 있는지
              안내해야 합니다.
            </p>
          </div>
          ...
          <div className={styles.principleCard}>
            ...
            <p className={styles.principleDescription}>
              다양한 브라우저와 보조 기기(스크린 리더 등)에서 올바르게 동작해야
              합니다. 의미에 맞는 HTML 태그와 표준 ARIA 속성을 사용하여 호환성을
              보장합니다.
            </p>
          </div>
        </div>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.sectionDescription}>
          저시력 사용자도 텍스트와 UI 요소를 명확히 구분할 수 있도록, TDS는
          충분한 색상 대비 비율을 유지합니다.
        </p>
        ...
        <div className={styles.infoBox}>
          ...
          <p className={styles.infoText}>
            색을 구분하기 어려운 사용자를 위해, 색상과 함께 아이콘이나 텍스트를
            반드시 병행하세요. 예를 들어 오류 상태는 빨간색 + 오류 아이콘 +
            &quot;오류&quot; 텍스트를 함께 표시합니다.
          </p>
        </div>
      </section>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.sectionDescription}>
          마우스를 사용할 수 없는 사용자를 위해, 인터랙션이 있는 주요 TDS
          컴포넌트는 키보드 조작과 포커스 이동을 고려해 구현했습니다.
        </p>
        ...
        <div className={styles.guidelineList}>
          <div className={styles.guidelineRow}>
            ...
            <span className={styles.guidelineText}>
              DOM 순서대로 논리적인 탭 순서를 유지하세요. tabindex 조작은
              최소화합니다.
            </span>
          </div>
          <div className={styles.guidelineRow}>
            ...
            <span className={styles.guidelineText}>
              모든 인터랙티브 요소에 명확한 포커스 인디케이터를 제공하세요. (3px
              outline, 배경과의 대비 3:1 이상)
            </span>
          </div>
          <div className={styles.guidelineRow}>
            <span className={styles.guidelineTitle}>포커스 트랩</span>
            <span className={styles.guidelineText}>
              모달, 사이드시트 등 오버레이 컴포넌트에서는 포커스가 외부로
              빠져나가지 않도록 제한합니다.
            </span>
          </div>
          <div className={styles.guidelineRow}>
            ...
            <span className={styles.guidelineText}>
              모달이 닫힐 때, 이전에 포커스되어 있던 요소로 포커스가 돌아가야
              합니다.
            </span>
          </div>
        </div>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.sectionDescription}>
          시각 장애인 사용자는 스크린 리더(화면 읽기 프로그램)를 통해 웹을
          탐색합니다. TDS 컴포넌트는 ARIA 속성을 적절히 사용하여 스크린 리더와
          호환됩니다.
        </p>
        ...
        <div className={styles.guidelineList}>
          <div className={styles.guidelineRow}>
            ...
            <span className={styles.guidelineText}>
              의미에 맞는 HTML 태그를 우선 사용하세요. button, dialog, alert 등
              역할은 필요할 때만 명시합니다.
            </span>
          </div>
          <div className={styles.guidelineRow}>
            ...
            <span className={styles.guidelineText}>
              아이콘 버튼처럼 눈에 보이는 텍스트가 없는 요소에 이름을
              제공합니다. 예: aria-label=&quot;닫기&quot;
            </span>
          </div>
          <div className={styles.guidelineRow}>
            <span className={styles.guidelineTitle}>aria-labelledby</span>
            <span className={styles.guidelineText}>
              화면에 이미 표시된 다른 요소의 텍스트를 레이블로 참조할 때
              사용합니다.
            </span>
          </div>
          <div className={styles.guidelineRow}>
            ...
            <span className={styles.guidelineText}>
              추가 설명이 필요한 경우 사용합니다. 예: 입력 필드 아래의 도움말
              텍스트를 연결합니다.
            </span>
          </div>
          <div className={styles.guidelineRow}>
            ...
            <span className={styles.guidelineText}>
              화면 내용이 동적으로 바뀔 때 스크린 리더에 알림을 보냅니다.
              polite(순서대로 읽기) 또는 assertive(즉시 읽기) 중 선택합니다.
            </span>
          </div>
          <div className={styles.guidelineRow}>
            <span className={styles.guidelineTitle}>aria-expanded</span>
            <span className={styles.guidelineText}>
              드롭다운, 아코디언 등 열림/닫힘 상태가 있는 요소에 현재 상태를
              표시합니다.
            </span>
          </div>
          <div className={styles.guidelineRow}>
            ...
            <span className={styles.guidelineText}>
              비활성화된 요소에 사용합니다. HTML disabled 속성과 함께 사용하면
              스크린 리더가 해당 요소가 비활성 상태임을 알려줍니다.
            </span>
          </div>
        </div>
      </section>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.sectionDescription}>
          TDS가 기본으로 처리하는 항목과, 직접 조합할 때 사용자가 확인해야 하는
          항목을 구분해 확인하세요.
        </p>
        ...
        <div className={styles.guidelineList}>
          <div className={styles.guidelineRow}>
            ...
            <span className={styles.guidelineText}>
              TextField, TextArea, Checkbox, Switch 등은 label prop을 제공하면
              내부 입력 요소와 연결됩니다. label 없이 직접 조합하는 경우에는
              aria-label 또는 aria-labelledby를 제공하세요.
            </span>
          </div>
          <div className={styles.guidelineRow}>
            <span className={styles.guidelineTitle}>오류 메시지</span>
            <span className={styles.guidelineText}>
              core 폼 컴포넌트는 errorMessage를 제공하면 aria-describedby로 입력
              필드와 연결합니다. 커스텀 오류 UI를 직접 만들 때는 오류 메시지
              id를 입력 요소의 aria-describedby에 연결하세요.
            </span>
          </div>
          <div className={styles.guidelineRow}>
            <span className={styles.guidelineTitle}>필수 입력</span>
            <span className={styles.guidelineText}>
              필수 입력 필드에는 required 속성 또는
              aria-required=&quot;true&quot;를 사용하세요.
            </span>
          </div>
        </div>
        ...
        <div className={styles.guidelineList}>
          <div className={styles.guidelineRow}>
            ...
            <span className={styles.guidelineText}>
              Modal, SideSheet, BottomSheet는 role=&quot;dialog&quot;와
              aria-modal을 기본으로 제공합니다. alertdialog가 필요한 경고성
              대화상자는 상황에 맞게 별도 속성을 검토하세요.
            </span>
          </div>
          <div className={styles.guidelineRow}>
            <span className={styles.guidelineTitle}>모달 상태</span>
            <span className={styles.guidelineText}>
              오버레이 컴포넌트는 aria-modal=&quot;true&quot;를 기본으로 설정해
              배경 콘텐츠와 분리된 대화상자임을 알립니다.
            </span>
          </div>
          <div className={styles.guidelineRow}>
            <span className={styles.guidelineTitle}>제목</span>
            <span className={styles.guidelineText}>
              Flat API에서 title prop을 사용하면 Modal, SideSheet, BottomSheet가
              제목 id와 aria-labelledby를 자동 연결합니다. Compound API로 제목을
              직접 구성할 때는 제목 요소 id를 aria-labelledby로 연결하세요.
            </span>
          </div>
          <div className={styles.guidelineRow}>
            <span className={styles.guidelineTitle}>닫기</span>
            <span className={styles.guidelineText}>
              ESC 닫기는 기본 옵션으로 제공됩니다. closeOnEscape를 끄거나 닫기
              버튼을 직접 구성하는 경우에는 키보드로 닫을 수 있는 다른 경로를
              제공하세요.
            </span>
          </div>
        </div>
        ...
        <div className={styles.guidelineList}>
          <div className={styles.guidelineRow}>
            ...
            <span className={styles.guidelineText}>
              반드시 button 태그를 사용하세요. 아이콘만 있는 경우 aria-label을
              제공합니다.
            </span>
          </div>
          <div className={styles.guidelineRow}>
            ...
            <span className={styles.guidelineText}>
              a 태그에 명확한 텍스트 또는 aria-label을 제공하세요. 새 창으로
              열리면 사용자에게 알려야 합니다.
            </span>
          </div>
          <div className={styles.guidelineRow}>
            ...
            <span className={styles.guidelineText}>
              체크박스나 스위치의 현재 상태를 aria-checked 또는 aria-pressed로
              표시합니다.
            </span>
          </div>
        </div>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.sectionDescription}>
          모바일 사용자와 운동 장애가 있는 사용자를 위해, 터치 가능한 영역은
          충분히 커야 합니다.
        </p>
        ...
        <div className={styles.guidelineList}>
          ...
          <div className={styles.guidelineRow}>
            ...
            <span className={styles.guidelineText}>
              터치 요소 사이에 최소 8px 이상의 간격을 두어 실수로 다른 요소를
              누르지 않도록 합니다.
            </span>
          </div>
          <div className={styles.guidelineRow}>
            ...
            <span className={styles.guidelineText}>
              Button, IconButton처럼 직접 누르는 액션 컴포넌트는 크기 옵션별
              조작성을 고려하고, Checkbox와 Switch는 label을 함께 제공해 클릭
              가능한 영역을 넓힙니다.
            </span>
          </div>
        </div>
        ...
        <div className={styles.infoBox}>
          ...
          <p className={styles.infoText}>
            TDS의 주요 인터랙티브 컴포넌트는 위 접근성 원칙을 기준으로 구현되어
            있습니다. 실제 화면의 문맥, 레이블, 색상 대비를 사용하는 쪽에서
            검증하는 것을 권장드립니다.
          </p>
        </div>
      </section>
